...
HEADER = f"""<header class=header><nav class=header-nav><div class=logo><a href=https://ayrix.online/ accesskey=h title="Ayrix (Alt + H)">Ayrix</a><div class=logo-switches><button id=theme-toggle class=theme-toggle accesskey=t title="(Alt + T)" aria-label="Toggle theme">
...
FOOTER = """<footer class=footer><span>© {year} Ayrix. All rights reserved.</span> ·
